...
!BOC
   ...
   integer (int_kind) :: &
      ...
      tavg_TAUX_2,       &! tavg_id for daily wind stress in X direction ! mluongo 10/19/2023
      tavg_TAUX2,        &! tavg_id for wind stress**2 in X direction
      tavg_TAUY,         &! tavg_id for wind stress in Y direction
      tavg_TAUY_2,       &! tavg_id for daily wind stress in Y direction ! mluongo 10/19/2023
...
!-----------------------------------------------------------------------
   ...
   call define_tavg_field(tavg_TAUX_2,'TAUX_2',2,                         &
                          long_name='Daily Windstress in grid-x direction', &
                          units='dyne/centimeter^2', grid_loc='2220', &
                          coordinates='ULONG ULAT time')
   !!!!!
   ...
   call define_tavg_field(tavg_TAUY_2,'TAUY_2',2,                         &
                          long_name='Daily Windstress in grid-y direction', &
                          units='dyne/centimeter^2', grid_loc='2220', &
                          coordinates='ULONG ULAT time')
   !!!!!  
...
!-----------------------------------------------------------------------
   ...
   do iblock = 1,nblocks_clinic
      ...
      call accumulate_tavg_field(SMF(:,:,1,iblock), tavg_TAUX_2,iblock,1) ! mluongo 10/19/2023
      call accumulate_tavg_field(SMF(:,:,1,iblock)**2, tavg_TAUX2,iblock,1)
      call accumulate_tavg_field(SMF(:,:,2,iblock), tavg_TAUY,iblock,1)
      call accumulate_tavg_field(SMF(:,:,2,iblock), tavg_TAUY_2,iblock,1) ! mluongo 10/19/2023
